...
const Become = () => {
  return (
    <div className='max-w-2xl flex flex-col  mx-auto justify-center items-center font-globalFont px-2 md:px-0'>
      ...
      <div>
        <div className='flex flex-row gap-8 justify-center items-center mb-2 m-4'>
        ...
        <div className='flex flex-row gap-8 justify-center items-center mb-4 m-2'>
          <img src={fund} alt="fund"  className='pr-2'/>
          <div>
            <h3 className='text-lg font-medium text-white'>Fundraising</h3>
            <p className='text-gray-300 text-medium text-sm'>Lorem, ipsum dolor sit amet
               consectetur adipisicing elit. Exercitationem ex id sit ratione non aspernatur!</p>
        ...
        <div className='flex flex-row gap-8 justify-center items-center mb-6 m-2'>
          <img src={fund} alt="fund"  className='pr-2'/>
          <div>
            <h3 className='text-lg font-medium text-white'>Fundraising</h3>
            <p className='text-gray-300 text-medium text-sm'>Lorem, ipsum dolor sit amet
        ...
        <div className='flex flex-row gap-8 justify-center items-center mb-8 m-4 '>
          <img src={fund} alt="fund" className='pr-2'/>
          <div>
            <h3 className='text-lg font-medium text-white'>Fundraising</h3>
            <p className='text-gray-300 text-medium text-sm'>Lorem, ipsum dolor sit amet
