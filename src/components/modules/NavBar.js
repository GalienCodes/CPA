  ...
  return (
    <div>
     <nav class="relative px-4 py-4 flex justify-between items-center ">
		...
		<div class="lg:hidden">
			<button class="navbar-burger flex items-center text-white p-3" onClick={()=>handeOpenIt()}>
		...
		<ul class="absolute top-1/2 left-1/4 transform-translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6 hidden">
			...
			<li>
			<Link to={'/about'}>
					<a class="text-sm text-gray-400 hover:text-gray-500" href="#">About</a>
			</Link>
			</li>
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div>
				<ul>
					<li class="mb-1">
					<Link to={'/'}>
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#" onClick={()=>handeOpenIt()}>Home</a>
					</Link>
					</li>
						<li class="mb-1">
							<Link to={'/mission'} onClick={()=>handeOpenIt()}>
									<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Mission</a>
							</Link>
						</li>
						<li class="mb-1">
							<Link to={'/team'} onClick={()=>handeOpenIt()}>
									<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Team</a>
							</Link>
						</li>
						<li class="mb-1">
						...
						<li class="mb-1">
							<Link to={'/contact'} onClick={()=>handeOpenIt()}>
			...
			<div class="mt-auto">
				<div class="pt-6">
					<a class="block px-4 py-3 mb-3  text-center font-semibold leading-none b text-sm text-gray-900 f rounded-2xl transition duration-200 bg-orange-300" href="#">DONATE</a>
					<a class="block px-4 py-3 mb-3  text-center font-semibold leading-none b text-sm text-gray-100 f rounded-2xl transition duration-200 bg-gray-700" href="#">JOIN THE MOVEMENT</a>
