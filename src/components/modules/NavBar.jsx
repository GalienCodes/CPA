  ...
  return (
    <div>
     <nav class="relative px-4 py-4 flex justify-between items-center ">
		...
		<ul class="hidden absolute top-1/2 left-1/4 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Mission</a></li>
			
			<li><a class="text-sm text-blue-600 font-bold" href="#">Team</a></li>
			
			<li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Resources</a></li>
